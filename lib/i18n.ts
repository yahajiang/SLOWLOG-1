...
export type Dict = {
  ...
  editorScheduleTitle: string;
  editorScheduleHint: string;
  editorConfirmSchedule: string;
  editorProcessing: string;
  editorCancel: string;
  editorScheduledDone: string;
  editorSettings: string;
  editorDeleteConfirm: string;
  editorDeleteDesc: (t: string) => string;
  editorDeleteBtn: string;
  editorPublished: string;
  editorDraftBadge: string;
  editorScheduledAt: (d: string) => string;
