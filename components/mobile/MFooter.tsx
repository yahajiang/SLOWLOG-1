    ...
    <footer className="mt-auto w-full border-t border-[var(--yh-border)] bg-[var(--dash-card)]">
      <div className="w-full mx-auto px-4 py-4 flex flex-col items-center gap-3 text-center">
        <div className="flex items-center gap-2 text-[12px]">
          ...
          <span className="mono text-[10px] px-1.5 py-0.5 rounded-none bg-[var(--dash-card)] border border-[var(--yh-border)] text-[var(--yh-muted)]">v{process.env.NEXT_PUBLIC_APP_VERSION || "0.3.5"}</span>
        </div>
