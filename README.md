...
> 配套：《整站风格蓝图》（preview-site）与《封面系统蓝图》（preview-covers）两份交互稿，可对照浏览。
...
| **加载态** | S 标 + 骨架卡 + 标语 | shimmer 骨架三条（100/75/50% 宽，200ms 级联）+ accent 呼吸点 + 「加载中」mono；正文区另有 pulse 占位 |
...
**© 2026 Yahajiang · 慢日志 SlowLog**

- 本设计文档与配套交互稿（《整站风格蓝图》《封面系统蓝图》）均为作者个人设计资产，**版权归 Yahajiang 所有**。
- 文档与代码仅供 SlowLog 项目自身使用及学习交流；如需引用或转载，请注明出处：作者 **Yahajiang**，并附本文链接。
- 商业转载请事先取得授权。联系：`yahajiang@gmail.com` · `github.com/yahajiang`。
