  ...
  return (
    <div className="min-h-screen bg-[var(--yh-bg)] flex items-center justify-center p-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="text-xl font-semibold text-[var(--yh-text)] mb-2">出错了</h1>
        <p className="text-sm text-[var(--yh-muted)] mb-6">
          {error.message || "发生了未知错误，请稍后重试。"}
        </p>
        <button
          onClick={reset}
          className="px-6 py-2 bg-[var(--yh-text)] text-[var(--yh-bg)] text-sm tracking-widest uppercase hover:bg-[var(--yh-accent)] transition-colors"
        >
          重试
        </button>
      </div>
